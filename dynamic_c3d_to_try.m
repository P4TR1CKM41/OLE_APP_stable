function [ftkratio, TRC_FILE, MOT_FILE, Y, Y_kinematic, markerStruct, forcesStruct, pf, af, FP_Corner_Points_of_FP_used, markers_from_c3d_filt, run_time]=dynamic_c3d_to_try(path, cut, FP_used, threshold, setup_Identifier, OPTIONS)
%% Cut
tic
...
try % skip if it is allready to short!
    if cut ==1
