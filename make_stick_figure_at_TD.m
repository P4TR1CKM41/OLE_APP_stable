function make_stick_figure_at_TD(OPTIONS, beine, MARKERS, FP, WINKEL, KINETICS, structname, kneefrontalplanemoment, CONTACT,  CONTACT_downsampled)
...
pos_vid= CONTACT_downsampled.(structname)(1); 
